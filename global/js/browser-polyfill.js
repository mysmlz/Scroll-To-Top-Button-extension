(function (global, factory) {
  ...
  /* webextension-polyfill - v0.2.1 - Fri Jul 06 2018 20:52:51 */
  ...
  if (browserUndefined || edge) {
    ...
    const wrapAPIs = () => {
      ...
      const makeCallback = (promise, metadata) => {
        return (...callbackArgs) => {
          if (extensionAPIsNamespace.runtime.lastError) {
            promise.reject(extensionAPIsNamespace.runtime.lastError);
      ...
      const wrappedSendMessageCallback = ({ reject, resolve }, reply) => {
        if (extensionAPIsNamespace.runtime.lastError) {
          ...
          if (extensionAPIsNamespace.runtime.lastError.message === CHROME_SEND_MESSAGE_CALLBACK_NO_RESPONSE_MESSAGE) {
            resolve();
          } else {
            reject(extensionAPIsNamespace.runtime.lastError);
          }
      ...
      return wrapObject(extensionAPIsNamespace, staticWrappers, apiMetadata);
    };
